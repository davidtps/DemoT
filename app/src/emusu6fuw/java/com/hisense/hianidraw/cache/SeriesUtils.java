...
public class SeriesUtils {
    ...
    public static final int EPOS_MIN_WIDTH = 349;//px
    ...
    //default mall logo
    public static final String DEFAULT_MALL_LOGO = "";//R.drawable.default_mall_logo1 + "-" + R.drawable.default_mall_logo2;//if no default set value :"",split:-  ps:R.drawable.soccer_1 + "-" + R.drawable.soccer_2
...
//        String netflixPackage = "com.netflix.ninja";
//        String youtubePackage = "com.google.android.youtube.tv";
        String katnissPackage = "com.google.android.katniss";
        if (enable) {
            ...
            StoreModeApplication.sContext.getPackageManager().setApplicationEnabledSetting(googlePlayStorePackage,
                    PackageManager.COMPONENT_ENABLED_STATE_ENABLED, 0);
//            StoreModeApplication.sContext.getPackageManager().setApplicationEnabledSetting(netflixPackage,
//                    PackageManager.COMPONENT_ENABLED_STATE_ENABLED, 0);
//            StoreModeApplication.sContext.getPackageManager().setApplicationEnabledSetting(youtubePackage,
//                    PackageManager.COMPONENT_ENABLED_STATE_ENABLED, 0);
            StoreModeApplication.sContext.getPackageManager().setApplicationEnabledSetting(katnissPackage,
                    PackageManager.COMPONENT_ENABLED_STATE_ENABLED, 0);
        } else {
...
//        int netflixPackageStatus = StoreModeApplication.sContext.getPackageManager().getApplicationEnabledSetting(netflixPackage);
//        int youtubePackageStatus = StoreModeApplication.sContext.getPackageManager().getApplicationEnabledSetting(youtubePackage);
        int katnissPackageStatus = StoreModeApplication.sContext.getPackageManager().getApplicationEnabledSetting(katnissPackage);
...
//        LogUtils.d(TAG, "modifyGoogleServiceSwitch() 3 is diable,1 is enable  netflixPackageStatus:" + netflixPackageStatus);
//        LogUtils.d(TAG, "modifyGoogleServiceSwitch() 3 is diable,1 is enable  youtubePackageStatus:" + youtubePackageStatus);
        LogUtils.d(TAG, "modifyGoogleServiceSwitch() 3 is diable,1 is enable  katnissPackageStatus:" + katnissPackageStatus);

        return gmsPackageStatus == 1 && googleVideoPackageStatus == 1 && googlePlayStorePackageStatus == 1
                && katnissPackageStatus == 1;
    }
