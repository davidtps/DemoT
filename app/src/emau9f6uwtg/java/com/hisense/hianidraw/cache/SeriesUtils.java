...
public class SeriesUtils {
    ...
    public static final int EPOS_MIN_WIDTH = 698;//299;//px
    public static final boolean SHOW_EPOS_FUNCTION = false;//true  show  ;false don't show epos function
    ...
    public static int DEFAULT_AUDIO_VOLUME = 0;   //default audio volume ; -1 means don't set default volume
    public static boolean SPECIAL_AQPQ_ADJUST = true;   //special_aqpq_adjust . true open this function;false close this function;
    ...
    public static final String KEY_PRODUCT_NAME_SYSTEM_PROPERTY = "ro.vt.product.model";//ps:[HU55U6FUW]
    public static final String KEY_BUILD_SOFTVERSION = "ro.vt.build.softversion";//V0000.01.00A
    ...
    public static void backupStoreSetting() {
        AvMiddleWareManager.backupStoreSetting();
    }
    ...
    public static Boolean isTvScanning() {
        boolean isTVScaning = PropertyUtils.getBoolean("sys.vt.tv.scanning", false);
        LogUtils.d(TAG, "PropertyUtils.get [sys.vt.tv.scanning]:" + isTVScaning);
        return isTVScaning;
    }
