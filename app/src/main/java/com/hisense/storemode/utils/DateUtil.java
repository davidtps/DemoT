...
public final class DateUtil {
     ...
     */
    private static final ThreadLocal<SimpleDateFormat> defaultDateTimeFormat = new
    ...
    private static final ThreadLocal<SimpleDateFormat> dateTimeFormat = new
            ThreadLocal<SimpleDateFormat>() {
     ...
     * yyyy-MM-dd格式
     */
    private static final ThreadLocal<SimpleDateFormat> defaultDateFormat = new
            ThreadLocal<SimpleDateFormat>() {
     ...
     * HH:mm:ss格式
     */
    private static final ThreadLocal<SimpleDateFormat> defaultTimeFormat = new
            ThreadLocal<SimpleDateFormat>() {
     ...
     * @param start
     * @param end
     * @return 1 开始时间小于结束时间， -1 开始时间大于结束时间  0 异常  2 开始时间等于结束时间
     */
    public static int compareDate(String start, String end) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            Date bt = sdf.parse(start);
